	...
	<div id="main">
		...
		<div id="header">
		  ...
		  <div id="logo_login">
			...
			<a href="index.php?m=home&c=user&a=edit"><div style="font-size:12px;">用户<?=$_SESSION['userInfo']['uname']?></div></a>
		<div style="font-size:12px;"><a href="/index.php?m=home&c=login&a=logout">退出</a></div>
              ...
              <table cellspacing="0" cellpadding="0"> 
               <tbody>
                <tr> 
                 ...
                 <td class="plc ptm pbn vwthd"> <h1 class="ts"> <a href="forum.php?mod=viewthread&amp;tid=6" id="thread_subject"><?=$post['title']?></a> </h1> <span class="xg1"> <a href="forum.php?mod=viewthread&amp;tid=6&amp;fromuid=1" onclick="return copyThreadUrl(this)" title="您的朋友访问此链接后，您将获得相应的积分奖励">[复制链接]</a> </span> </td> 
                </tr> 
               </tbody>
              </table> 
                ...
                <tbody>
                 <tr> 
                  <td class="pls" rowspan="2"> <a name="lastpost"></a> 
                   <div class="pi"> 
                    <div class="authi"> 
                     <a href="home.php?mod=space&amp;uid=1" target="_blank" class="xw1"><? = $users[$post['uid']]['uname'] ?></a> 
                    </div> 
                   </div> 
                   <div> 
                    <div class="avatar" onmouseover="showauthor(this, 'userinfo16')">
                     <a href="home.php?mod=space&amp;uid=1" target="_blank"><img src="/<?=getSm($users[$post['uid']]['uface'])?>" /></a>
                    </div> 
                    <div class="tns xg2"> 
                     <table cellspacing="0" cellpadding="0"> 
                      <tbody>
                    ...
                    <div class="pcb"> 
                     <div class="t_fsz"> 
                      <table cellspacing="0" cellpadding="0">
                       <tbody>
                        <tr>
                         <td class="t_f" id="postmessage_16"><? = $post['content'] ?></td>
                        </tr>
                       </tbody>
                      </table> 
                     </div> 
               ...
               <table id="pid16" summary="pid16" cellspacing="0" cellpadding="0"> 
                <tbody>
                 <tr> 
                  ...
                  <td class="plc"> 
                   <div class="pi"> 
                    <strong> <a href="forum.php?mod=viewthread&amp;tid=6&amp;fromuid=1">第<?=$n++?>楼</a> </strong> 
                    <div class="pti"> 
                     <div class="pdbt"> 
                     </div> 
                     <div class="authi"> 
                      <img class="authicn vm" id="authicon16" src="/Public/Home/images/common/online_admin.gif" /> 
                      <em id="authorposton16">发表于 <span title="2018-5-4 11:05:56"><?=date('Y-,-d H:i:s',$reply['created_at'])?></span></em> 
                      <span class="pipe">|</span>
                      <a href="forum.php?mod=viewthread&amp;tid=6&amp;extra=&amp;ordertype=1">倒序浏览</a> 
                      <span class="pipe">|</span> 
                     </div> 
                    ...
                    <div class="pcb"> 
                     <div class="t_fsz"> 
                      <table cellspacing="0" cellpadding="0">
                       <tbody>
                        <tr>
                         <td class="t_f" id="postmessage_16"><?= $reply['rcontent']?></td>
                        </tr>
                       </tbody>
                      </table> 
                     </div> 
                ...
                <tbody>
                 <tr> 
                  ...
                  <td class="plc"> <span id="fastpostreturn"></span> 
                   ...
                   </div> <p class="ptm pnpost"> <button type="submit" id="fastpostsubmit" class="pn pnc vm" value="replysubmit" tabindex="5"><strong>发表回复</strong></button> </p> </td> 
                 </tr> 
                </tbody>
               </table> 
              </form> 
