	...
	<div id="main">
		...
		<div id="header">
		  ...
		  <div id="logo_login">
			...
			<a href="index.php?m=home&c=center&a=edit"><div style="font-size:12px;">用户<?=$_SESSION['userInfo']['uname']?></div></a>
...
<!--内容部分start-->
		<div class="content">			
			<form action="/index.php?m=home&c=center&a=edit" method="post">
				<table align="center" width="300" height="60">
					...
					<tr>
						<td><label>修改头像:</label></td>
						<td><input type="file" name="uface"></td>
					</tr>
