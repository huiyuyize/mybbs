            ...
            <ul class="sidebar-list">
                ...
                <li>
                 ...
                 <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="/index.php?m=admin&c=tiezi&a=index"><i class="icon-font">&#xe045;</i>查看贴子</a></li>
                    </ul>
                </li>
            </ul>
        </div>
                    ...
                    <table class="result-tab" width="100%">
                       ...
                       <?php foreach($parts as $part):?>
                        <tr>
                            ...
                            <td><?=$part['pname']?></td>
                            <td>
                                <a class="link-update" href="/index.php?m=admin&c=tiezi&a=edit&pid=<?=$part['pid']?>">修改</a>
                                <a class="link-del" href="/index.php?m=admin&c=tiezi&a=del&pid=<?=$part['pid']?>">删除</a>
                            </td>
                        </tr>
                        <?php endforeach;?>
                    </tbody></table>
