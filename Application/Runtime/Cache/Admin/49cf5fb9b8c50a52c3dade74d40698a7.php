                ...
                <form action="/index.php?m=admin&c=user&a=save" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                <th>密码：</th>
                                <td><input class="common-text" name="upwd" size="50" type="password"></td>
                            </tr>
                            <tr>
                                <th>确认密码：</th>
                                <td><input class="common-text" name="reupwd" size="50" type="password"></td>
                            </tr>
                            <tr>
                                <th>性别：</th>
                                <td>
                                	...
                                	<input class="common-text" name="sex" size="50" value="x" type="radio">保密     </td>
