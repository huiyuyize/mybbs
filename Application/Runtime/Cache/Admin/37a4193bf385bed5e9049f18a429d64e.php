    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/index.php?m=admin&c=reply&a=update&rid=<?php echo ($reply['rid']); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th>内容：</th>
                                <td><textarea name="rcontent" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo ($reply['rcontent']); ?></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
