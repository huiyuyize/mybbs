                        ...
                        <tbody><tr>
                            ...
                            <td>
                                <select name="auth" id="catid" class="required">
                                    <option  <?php if($user['auth']==0){echo 'selected';} ?> value="0">超级管理员</option>
                                    <option  <?php if($user['auth']==1){echo 'selected';} ?> value="1">管理员</option>
                                    <option  <?php if($user['auth']==2){echo 'selected';} ?> value="2">用户</option>
                                </select>
                            </td>
                        </tr>
                            <tr>
